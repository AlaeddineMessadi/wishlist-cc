...
router.post('/wishlists/:wishlist_id', custom.wishlist, WishlistController.addArticleToWishlist);
router.delete('/wishlists/:wishlist_id/:article_id/:productid', custom.wishlist, custom.article, WishlistController.removeArticleToWishlist);
